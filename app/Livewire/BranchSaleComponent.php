...
class BranchSaleComponent extends Component
{
    ...
    public $extraMoney;
    public $branchSales;
    public $receiver_name; // Added receiver_name property
    ...
    protected $rules = [
        ...
        'receiver_name' => 'required|string|max:255', // Add validation rule for receiver_name
    ];
    ...
    public function saveSale()
    {
        ...
        $this->validate([
            ...
            'cash' => 'required|numeric|min:0',
            'receiver_name' => 'required|string|max:255', // Add validation for receiver_name
        ]);
        ...
        \DB::transaction(function () {
            ...
            $branchSale = BranchSale::create([
                ...
                'cash' => $this->cash,
                'receiver_name' => $this->receiver_name, // Add receiver_name to the create array
            ]);
    ...
    private function resetInputFields()
    {
        ...
        $this->totalPrice = null;
        $this->cash = null;
        $this->receiver_name = null; // Reset receiver_name field
    }
