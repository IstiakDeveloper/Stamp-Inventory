<div class="p-6 bg-white border border-gray-300 rounded-lg shadow-md">
    ...
    <div class="overflow-x-auto">
        ...
        <div class="mt-6 text-right">
            <button id="download-pdf" class="px-4 py-2 font-semibold text-white bg-blue-600 rounded-md shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">Download PDF</button>
        </div>
    </div>
