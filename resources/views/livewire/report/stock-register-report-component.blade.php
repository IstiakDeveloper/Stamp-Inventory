<div class="p-6">
    ...
    <div id="content-to-pdf" class="bg-white rounded-lg shadow-md p-4">
        ...
        <table class="min-w-full bg-white">
            ...
            <tbody>
                ...
                <!-- Cumulative Totals -->
                <tr class="bg-green-200 font-bold">
                    <td class="py-4 px-6 border-b border-gray-300">Total Cummulative:</td>
        ...
        <div class="mt-6">
            <button id="download-pdf" class="px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition duration-150 ease-in-out">Download PDF</button> 
        </div>
    </div>
